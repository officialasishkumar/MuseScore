...
MUSESCORE_DOWNLOAD_MACOS_DEPS=${MUSESCORE_DOWNLOAD_MACOS_DEPS:-"OFF"}
...
MUSESCORE_BUILD_MNX_MODULE=${MUSESCORE_BUILD_MNX_MODULE:-"OFF"}
...
function do_build() {
    ...
    cmake .. -GNinja \
        ...
        -DMUE_DOWNLOAD_MACOS_PRECOMPILED_DEPS="${MUSESCORE_DOWNLOAD_MACOS_DEPS}" \
        ...
        -DMUE_BUILD_IMPEXP_MNX_MODULE="${MUSESCORE_BUILD_MNX_MODULE}"
